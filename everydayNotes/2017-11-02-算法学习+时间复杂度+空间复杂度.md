...
- 2、快速排序
 ...
                var pivotIndex = Math.floor(arr.length / 2);//基准下标Math.floor()向下取整
                var pivot = arr.splice(pivotIndex, 1)[0];//剔除基准,返回剔除后的array
                var left = [];
                var right = [];
 ...
                return quickSort(left).concat([pivot], quickSort(right));//concat()连接两个数组
              };
